...
import com.xj.IntelligentInterviewPlatform.mapper.QuestionBankQuestionMapper;
import com.xj.IntelligentInterviewPlatform.model.dto.questionBankQuestion.QuestionBankQuestionQueryRequest;
import com.xj.IntelligentInterviewPlatform.model.entity.Question;
import com.xj.IntelligentInterviewPlatform.model.entity.QuestionBank;
import com.xj.IntelligentInterviewPlatform.model.entity.QuestionBankQuestion;
import com.xj.IntelligentInterviewPlatform.model.entity.User;
import com.xj.IntelligentInterviewPlatform.model.vo.QuestionBankQuestionVO;
import com.xj.IntelligentInterviewPlatform.model.vo.UserVO;
import com.xj.IntelligentInterviewPlatform.service.QuestionBankQuestionService;
import com.xj.IntelligentInterviewPlatform.service.QuestionBankService;
...
//        }
    ...
    public void batchAddQuestionsToBank(List<Long> questionIdList, Long questionBankId, User loginUser) {
        ...
        List<Long> validQuestionList = questionService.listObjs(wrapper, obj -> (Long) obj);
        ThrowUtils.throwIf(CollUtil.isEmpty(validQuestionList), ErrorCode.PARAMS_ERROR, "有效题目为空");
        //从数据库校验并获取有效题库id
        QuestionBank validQuestionBankId = questionBankService.getById(questionBankId);
        ThrowUtils.throwIf(validQuestionBankId == null, ErrorCode.PARAMS_ERROR);
        ...
        ThrowUtils.throwIf(CollUtil.isEmpty(validQuestionList), ErrorCode.PARAMS_ERROR, "所有题目都已存在于题库中");
        // 自定义线程池
        ...
        int batchSize = 1000;
        int totalQuestionListSize = validQuestionList.size();
        for (int i = 0; i < totalQuestionListSize; i += batchSize) {
            // 生成每批次的数据
            List<Long> subList = validQuestionList.subList(i, Math.min(i + batchSize, totalQuestionListSize));
    ...
    public void batchRemoveQuestionsFromBank(List<Long> questionIdList, Long questionBankId) {
        ...
        for (Long questionId : questionIdList) {
            ...
            ThrowUtils.throwIf(res == false, ErrorCode.OPERATION_ERROR, "从题库删除题目失败");
        }
    }
